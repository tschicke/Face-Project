...
void read_polygon_colors(const char* FileName, HEAD * face) {
	FILE *InFile;
	int i, ii;
	...
	face->polyColor = (float *) malloc(face->npolylinenodes * 3 * sizeof(float));
...
void read_vertex_constrictors(const char * FILENAME, HEAD * h) {
	FILE * file;
